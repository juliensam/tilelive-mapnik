...
LockingCache.prototype.get = function(id, callback) {
    ...
    if (this.results[id]) {
        ...
        if(this._mbtiles) {
            ...
            if(this._mbtiles._mapCache && this._mbtiles._mapCache[coords] && this._mbtiles._mapCache[coords].tile_id &&
               this._mbtiles._tileCache && this._mbtiles._tileCache[this._mbtiles._mapCache[coords].tile_id]) {
